...
개인 Google 계정의 Form·Sheets·Drive·Apps Script로 구현·검증합니다. 회사 계정 전환과 Cafe24 배포는 이후 진행합니다.
...
- Google Form으로 입력·수정하고 같은 계정의 재제출은 기존 명함을 갱신합니다.
...
- 프로필은 사진 또는 영상 한 개이며 별도 프로필 배경은 없습니다. 직무·연락처·회사·링크 카드는 기본 영상 또는 직원별 이미지·영상입니다. 기본 영상은 각각 `role.mp4`, `contact.mp4`, `web.mp4`, `links.mp4`입니다.
- 신규 배경 미첨부는 기본값, 재제출 시 미첨부는 기존 배경 유지입니다. 기본 배경 복원은 입력 흐름에서 처리합니다.
- 이미지: JPG/JPEG·PNG·WEBP. 영상: MP4, 최대 5초·2560×1440·18MB.
